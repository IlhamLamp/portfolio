            ...
            <div className='grid lg:grid-cols-5 gap-8'>
                ...
                <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
                    <div className='lg:p-4 h-full'>
                        <div>
                            <img className='rounded-xl hover:scale-105 ease-in duration-300' src="https://www.pcworld.com/wp-content/uploads/2023/05/dell-g2723h-1.jpg?quality=50&strip=all" alt="/" />
                        </div>
                        <div>
                            <h2 className="p2">Name Here</h2>
                    ...
                    <div className='p-4'>
                        <form>
                            ...
                            <div className='flex flex-col py-2'>
                                ...
                                <textarea className='border-2 rounded-lg p-3 flex border-gray-300' rows='5' />
                            </div>
